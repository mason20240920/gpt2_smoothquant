...
if __name__ == '__main__':
    purpose: str = "quant"
    if purpose == "scales":
        ime_gpt2_path: str = os.path.join("/Users/mason/Desktop/Desktop/PythonProjects/ime_gpt_2/output", 'model_901')
        ...
        input_ids: torch.LongTensor = torch.tensor([0, 3, 48, 44, 23], dtype=torch.long)
        # 5. 进行推理
        output = int8_model(input_ids)
